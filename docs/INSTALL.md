...
```powershell
python -m venv .venv
.venv\Scripts\python.exe -m pip install "https://github.com/avalonreset/legends-dataforseo-kit/releases/download/v0.3.1/legends_dataforseo_kit-0.3.1-py3-none-any.whl"
...
```sh
python3 -m venv .venv
.venv/bin/python -m pip install "https://github.com/avalonreset/legends-dataforseo-kit/releases/download/v0.3.1/legends_dataforseo_kit-0.3.1-py3-none-any.whl"
...
```sh
python -m pip install "https://github.com/avalonreset/legends-dataforseo-kit/archive/refs/tags/v0.3.1.zip"
```
...
```powershell
Get-FileHash -Algorithm SHA256 .\legends_dataforseo_kit-0.3.1-py3-none-any.whl
```

```sh
sha256sum legends_dataforseo_kit-0.3.1-py3-none-any.whl
# macOS alternative: shasum -a 256 legends_dataforseo_kit-0.3.1-py3-none-any.whl
```
